const products =[
    ...
    {   
        ...
        gender : ['male'], 
        price : 40,
        img : [`./media/img/apparel/T-shirt/ADIDAS X ZOE SALDANA COLLECTION WOMEN'S LONG SLEEVE SHIRT.jpg` ],
    ...
    {   
        ...
        gender : ['female'],
        price : 400,
        img :[`./media/img/appared/jacket/COLD.RDY DOWN JACKET.jpg`,`./media/img/appared/jacket/COLD.RDY DOWN JACKET 2.jpg`],
    ...
    {   
        ...
        gender : ['male','female'],
        price : 350,
        img: ['./media/img/apparel/HAT/hat1.jpg','./media/img/apparel/HAT/hat2.jpg'],
    ...
    {   
        ...
        gender : ['female'],
        price : 750,
        img: ['./media/img/apparel/SCARF/scarf1.jpg','./media/img/apparel/SCARF/scarf2.jpg'],
    ...
    {   
        ...
        gender : ['unisex'],
        price : 850,
        img: ['./media/img/apparel/BAG/BLACK LOGO BACKPACK.jpg','./media/img/apparel/BAG/BLACK LOGO BACKPACK 2.jpg'],
    ...
    {   
        ...
        material : ['brass'],
        price : 300,
        img: ['./media/img/apparel/RING/ring1.jpg','./media/img/apparel/RING/ring2.jpg'],
    ...
    },
    {
        ...
        color : ['black','while'],
        gender : ['female'],
        img:[`./media/img/apparel/BAG/1-1.jpg`,`./media/img/apparel/BAG/1-2.jpg`],        
        price : 2650,
        productType : `bag`,
    },
    {
        ...
        color : ['black','grey'],
        gender : ['female'],
        img:[`./media/img/apparel/BAG/3.jpg`,`./media/img/apparel/BAG/3-2.jpg`,`./media/img/apparel/BAG/3-3.jpg`],        
        price : 2250,
        productType : `bag`,
    },
    {
        ...
        gender : ['female'],
        img:[`./media/img/apparel/BAG/2.jpg`,`./media/img/apparel/BAG/2-2.jpg`],        
        price : 1980,
        productType : `bag`,
    },
    {
    ...
    {   id: '32',
        ...
        gender : ['male'],
        price : 150,
        img:[`./media/img/apparel/Polo/Nike Dri-FIT Player`],
