...
dataJob = [
    ...
    //  console.log('Job hit : \n ' );
    //  for( let i = 0 ; i < job1.benefits.length ; i++){
    //     console.log(job1.benefits[i]);
    // }
    //  2.6
    //  console.log('First job hit benefit:\n');  
    //  for( let i = 0 ; i < dataJob.length ; i++){
    //      console.log(job1.benefits[i].benefitValue);
    //  }
    //  2.7
    //  for( let i = 0 ; i < dataJob.length ; i++){
    //     console.log(dataJob[i].jobTitle);
    //     console.log('Benefits :')
    //      for( let j =0 ; j < dataJob[i].benefits.length; j++){
    //          console.log ('- ' + dataJob[i].benefits[j].benefitValue);
    //      }
    //      console.log('--------------------------------------------------------------------');
    //  }
    ...
    // 2.8 :
    for(let i=0; i<dataJob.length; i++){
        console.log('Title: '+dataJob[i].jobTitle);
        console.log('Salary: '+dataJob[i].jobSalary);
        ...
        console.log('Skill:');
        for(let x=0; x<dataJob[i].skills.length; x++){
            console.log('- '+dataJob[i].skills[x]);
        }
        console.log('------------------------------------------')
    }